  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci esse labore facilis, illo harum in ea, vero ad numquam, omnis nam corrupti? Fuga, vero blanditiis reprehenderit odio dolores id reiciendis?</p>
            <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-2/4 my-14'>
                <div>
